...
public class JSONHortoFruticolaPacker implements IJSONPacker<StockHortoFruticola> {
    File jsonFile;
    File csvFile;

    @Override
    public String packageData(List<StockHortoFruticola> datos) throws IOException {
        IJSONConverter<StockHortoFruticola> converter = new JSONHortoFruticolaConverter();
